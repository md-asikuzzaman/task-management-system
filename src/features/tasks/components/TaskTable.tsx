                    ...
                    >
                      <div className="flex items-start gap-2">
                        <div>
                          ...
                          {task.description ? (
                            <div className="mt-1 max-w-60 truncate text-xs text-slate-500">
                              {task.description}
                            </div>
                          ) : null}
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                      {task.owner ? (
                        <>
                          ...
                          <span className="max-w-35 truncate text-sm text-slate-700">
                            {task.owner.name}
                          </span>
                        </>
                      ) : (
                    ...
                    <DropdownMenu.Root>
                      ...
                      <DropdownMenu.Portal>
                        <DropdownMenu.Content
                          align="start"
                          className="z-50 min-w-45 rounded-xl border border-slate-200 bg-white p-1 shadow-xl"
                        >
            ...
            >
              ...
              <div className="mt-3 flex items-center justify-between gap-2">
                ...
                <button
                  type="button"
                  onClick={() => onOpenTask(task.id)}
                  className="rounded-md border border-slate-200 bg-white px-2 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-200"
                >
                  Details
                </button>
              </div>
